...
As I became more comfortable with GitHub I moved beyond "😫 help me Google" and towards reading "the docs" a la [RTFM](http://www.readthefuckingmanual.com/). I put "docs" in quotes because reading the docs for me usually means ~~reading~~ skimming a project's README. 
...
1. Issues or Pull Requests on _other_ projects that had the same issue. This may take some detective work 🕵️‍♂️, but if someone makes an Issue within their own repository linking to an Issue or Pull Request within the library's repository, you may be able to see what they did in their project to solve the problem.
